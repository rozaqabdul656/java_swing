 ...
 * @author ASUS
 */
public class pinjaman extends javax.swing.JPanel {
    entitaspinjaman obj=new entitaspinjaman();
    crudpinjaman obc=new crudpinjaman();
    int savecek=0;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tanggal Pinjaman");

        tanggal.setDateFormatString("yyyy-MM-dd");

        jLabel4.setText("Nama ");

        jLabel9.setText("Besar Pinjaman");
        ...
        jLabel5.setText("Maksimal Pinjaman Sebesar 20 000");
        ...
        jLabel7.setText("Jaminan Pinjaman");

        jaminan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jaminanKeyTyped(evt);
            }
        });
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jaminan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(98, 98, 98))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseClicked
        if (simpanan.getText().isEmpty()||tanggal.getDate()== null || jaminan.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, " Lengkapi Data Anda !");  
               ...
               double ta=Double.parseDouble(simpanan.getText());
               if (ta <= 20000 ) {
                    obj.setNim(id.getText());
                    obj.setBesar_pinjaman(simpanan.getText());
                    obj.setDate(new SimpleDateFormat("yyyy-MM-dd").format(tanggal.getDate()));
                    obj.setJaminan(jaminan.getText().toUpperCase());
                    obc.minjamanggota(obj);
                    refresh();
                    disabled();
                    tambahbaru.setVisible(false);
                    save.setVisible(false);
               }else{
                    JOptionPane.showMessageDialog(null, "Pinjaman Maksimal sebesar 20000  ");  
    ...
    private void jaminanKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jaminanKeyTyped
        obv.cek_nama(evt);
    }//GEN-LAST:event_jaminanKeyTyped
