 ...
 * @author ASUS
 */
public class pembayaranpinjaman extends javax.swing.JPanel {
    entitaspembayran obj=new entitaspembayran();
    crudpembayaran obc=new crudpembayaran();
    validasi obv=new validasi();
   
    public pembayaranpinjaman(){
        initComponents();
        disabled();
   ...
   private void refresh(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Pembayaran Pinjaman Anggota");
        ...
        jLabel9.setText("Besar Pembayaran");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_refresh_16px.png"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(simpanan, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
                                            .addComponent(cari, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
                                            .addComponent(totalp))
                                        .addGap(130, 130, 130))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseClicked
       ...
       if (tanggal.getDate()== null || simpanan.getText().isEmpty()) {
            ...
            obj.setBesar_pembayaran(simpanan.getText());
            obj.setDate(new SimpleDateFormat("yyyy-MM-dd").format(tanggal.getDate()));

            double bayar=Double.parseDouble(simpanan.getText());
            double pinjam=Double.parseDouble(totalp.getText());

       
            if (bayar == pinjam){
               obc.deleteminjamanggota(id.getText());
                refresh();
                disabled();
                tambahbaru.setVisible(false);
                save.setVisible(false);

            }else if(bayar > pinjam){
                  JOptionPane.showMessageDialog(null, "Nominal Yang Anda bayar terlalu Banyak !"); 
                  simpanan.setText("");
            }else {
                obc.bayaranggota(obj);
                refresh();
                disabled();
                tambahbaru.setVisible(false);
                save.setVisible(false);
    ...
    private void anggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_anggotaMouseClicked
        ...
        totalp.setText((String) anggota.getValueAt(a,3));
    ...
    private void totalpKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_totalpKeyTyped
      obv.cek_nama(evt);
    }//GEN-LAST:event_totalpKeyTyped
